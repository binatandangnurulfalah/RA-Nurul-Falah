      ...
      {showUpdate && (
        <section className="pwa-status-card update" role="status">
          ...
          <div>
            ...
            <p>Perbarui saat online agar aplikasi, schema, dan fitur tetap sinkron.</p>
      ...
      {showInstall && (
        <section className="pwa-status-card install" role="status">
          ...
          <div>
            ...
            <p>Tambahkan ke layar utama untuk akses lebih cepat tanpa mengubah aturan keamanan data.</p>
            <div className="pwa-status-actions">
