...
begin
  ...
  select count(*)::integer,
    ...
    into v_attendance_today, v_late_today
  ...
  return jsonb_build_object(
    ...
    'absent_today', greatest(v_active_students - v_attendance_today, 0),
...
comment on function public.dashboard_summary() is
  'Role-scoped dashboard summary. SECURITY INVOKER intentionally preserves RLS filtering for Admin, Guru, and Wali.';
